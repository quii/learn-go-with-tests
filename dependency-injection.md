...
It is assumed that you have read the [structs section](./structs-methods-and-interfaces) before as some understanding of interfaces will be needed for this.
