...
The vast majority of the standard library has excellent documentation with examples. Navigating to [https://pkg.go.dev/](https://pkg.go.dev/) would be worthwhile to see what's available to you.
