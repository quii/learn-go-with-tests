...
7. [Dependency Injection (WIP)](/di-1) - Learn about dependency injection, how it relates to using interfaces and a primer on io.
8. [Mocking (WIP)](/di-2) - Take some existing untested code and use DI with mocking to test it.
9. Concurrency (WIP)
